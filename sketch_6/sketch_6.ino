...
// pid제어기 변수
// 오른쪽용 PID제어기 제어 이득
const double right_proportion = 2;
const double right_integral = 1;
const double right_derivative = 0;
// 오른쪽용 PID제어기 제어 이득
const double left_proportion = 2;
const double left_integral = 1;
const double left_derivative = 0;
